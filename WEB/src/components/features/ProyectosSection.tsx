...
//     imagen: Proyecto1,
//     descripcion:
//       "Vivienda unifamiliar de estilo contemporáneo, diseñada con espacios abiertos, iluminación natural y acabados minimalistas.",
//   },
//   {
//     nombre: "Edificio Corporativo Nova",
//     imagen: Proyecto2,
//     descripcion:
//       "Diseño arquitectónico para oficinas modernas, con un enfoque en eficiencia energética y funcionalidad empresarial.",
//   },
//   {
//     nombre: "Casa de Campo El Retiro",
//     imagen: Proyecto3,
//     descripcion:
//       "Proyecto residencial rústico que combina materiales tradicionales con confort moderno, en armonía con el entorno natural.",
//   },
//   {
//     nombre: "Centro Cultural Horizonte",
//     imagen: Proyecto4,
//     descripcion:
//       "Espacio público multifuncional orientado al arte y la comunidad, con una propuesta arquitectónica innovadora y accesible.",
//   },
//   {
//     nombre: "Departamento Urbano Vista 360",
//     imagen: Proyecto5,
//     descripcion:
//       "Diseño de interiores y remodelación de un departamento en altura, optimizando vistas, confort y estilo.",
//   },
//   {
//     nombre: "Parque Lineal Río Verde",
//     imagen: Proyecto6,
//     descripcion:
//       "Proyecto urbano que integra paisajismo, movilidad sostenible y espacios recreativos en la ribera de un río.",
//   },
// ];
...
//       {/* Contenido */}
//       <div className="p-6">
//         <h2 className="text-xl font-bold text-gray-900 mb-3">{proyecto.nombre}</h2>
...
//             <span className="text group-hover:!ps-2 text-secondary ps-2 Poppins-Font flex items-center gap-2">
//               <BsSend size={20} />
//               Contacto
//             </span>
